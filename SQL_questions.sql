...
#// Väljer book_count som är ett alias från mitt subquery och gör en avg på den
#// i subqueryt räknas böcker som book_count och filtreras ut från år större än 2000
